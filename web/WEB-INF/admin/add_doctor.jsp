            ...
            <form id="add_form" action="add_doctor.php" method="post" >
                ...
                <div class="form-group" align="left">
                    <div class="input-group">
                        ...
                        <input type="text" id="position" name="position" placeholder="职位：挂号/诊断/收款"
                               class="form-control"
                               aria-describedby="sizing-addon2" >
                    </div>
                </div>
                <div class="form-group" align="left">
                    <div class="input-group">
                        ...
                        <input type="text" id="department" name="department" placeholder="所在科室：内分泌科/精神科/老年科/儿童科/牙科/呼吸内科" class="form-control"
                               aria-describedby="sizing-addon2">
                    </div>
                </div>
                <div class="form-group" align="left">
